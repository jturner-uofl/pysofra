...
PySofra a harassment-free experience for everyone, regardless of age,
...
This Code of Conduct applies within all PySofra community spaces — the
issue tracker, pull requests, code review comments, the project's
discussion forums, and email correspondence about the project — and
...
**jason.turner@louisville.edu**. All complaints will be reviewed and
...
1. **Correction** — *Community Impact*: Use of inappropriate language
   or other behaviour deemed unprofessional or unwelcome in the
   community. *Consequence*: A private, written warning, providing
   clarity around the nature of the violation and an explanation of
   why the behaviour was inappropriate. A public apology may be
   requested.

2. **Warning** — *Community Impact*: A violation through a single
   incident or series of actions. *Consequence*: A warning with
   consequences for continued behaviour. No interaction with the
   people involved, including unsolicited interaction with those
   enforcing the Code of Conduct, for a specified period of time.

3. **Temporary ban** — *Community Impact*: A serious violation of
...
4. **Permanent ban** — *Community Impact*: Demonstrating a pattern of
   ...
   disparagement of classes of individuals. *Consequence*: A
